                                            ...
                                            <div style="margin-left:1px; margin-top:2px; margin-right:10px "><br>
                                                ...
                                                <?php if (!$isLoggedIn): ?>
                                                    <form method="post" style="margin-top: 10px;">
                                                        ...
                                                        <input type="text" name="login" required style="width: 150px;"><br>
                                                        <label>Пароль:</label><br>
                                                        <input type="password" name="password" required style="width: 150px;"><br><br>
              ...
              <tr>
                <td valign="top" width="583" height="68" background="images/row3.gif">
                    <div style="margin-left:51px; margin-top:31px ">
                        ...
                        <?php if ($isLoggedIn): ?>
                            <a><input value="Выйти" type="button" onclick="location.href='?logout'"/></a>
                        <?php else: ?>
